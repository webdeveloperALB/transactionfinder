/*
  # Update Payment Flow and Search Process

  1. Changes
    - Add payment_status column to search_results
    - Add payment_required column to search_results
    - Add payment_completed_at column to search_results
